...
ifneq ($(filter seraph lahaina taro blair kalama pineapple monaco kona pitti niobe volcano anorak61 neo61,$(TARGET_BOARD_PLATFORM)),)
...
ifeq ($(USB_USES_QMAA),true)
  ...
  #
  ifneq ($(filter niobe taro kalama pineapple blair monaco kona pitti volcano anorak61 neo61,$(TARGET_BOARD_PLATFORM)),)
